...
Popout {
    ...
    Column {
        ...
        // Devices and per-application streams both grow with whatever is
        // plugged in and playing. Cap the pair at half the screen and scroll,
        // rather than letting the panel run off the bottom.
        Flickable {
            width: parent.width
            height: Math.min(audioColumn.implicitHeight, root.maxContentHeight)
